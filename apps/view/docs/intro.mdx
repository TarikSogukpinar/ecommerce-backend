...
### Me : `http://localhost:3015/api/v1/user/me`
...
### Try the `http://localhost:6060/api/products` API

<TryApiExample apiEndpoint="http://localhost:6060/api/products" token="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6ImNtMHVnMmRuajAwMDBwaXdqZzk4NHRsc3kiLCJleHAiOjE3MzQ1ODQzMTl9.cw58OwvcQjfKIlu9yovuqQkDp3X__L4t9uWvTSjQ7kc" />
