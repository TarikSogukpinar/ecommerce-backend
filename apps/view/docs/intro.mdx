...
<TryApiExample apiEndpoint="https://mock-api.tariksogukpinar.dev/nest/api/v1/user/me" token="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6ImNtMHVnMmRuajAwMDBwaXdqZzk4NHRsc3kiLCJleHAiOjE3MzQ1ODQzMTl9.cw58OwvcQjfKIlu9yovuqQkDp3X__L4t9uWvTSjQ7kc" />

### Try the `https://mock-api.tariksogukpinar.dev/go/api/products` API

<TryApiExample apiEndpoint="https://mock-api.tariksogukpinar.dev/go/api/products" token="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6ImNtMHVnMmRuajAwMDBwaXdqZzk4NHRsc3kiLCJleHAiOjE3MzQ1ODQzMTl9.cw58OwvcQjfKIlu9yovuqQkDp3X__L4t9uWvTSjQ7kc" />
